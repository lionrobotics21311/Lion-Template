...
public class Constants {
    ...
    public static ForesightConfig foresightConfig = new ForesightConfig(
            c -> {
                // These are example values provided by Pedro Pathing
                // These values will vary robot to robot, so it is important to tune your robot
                // Everytime you make major changes that affects the weight or speed of your robot
